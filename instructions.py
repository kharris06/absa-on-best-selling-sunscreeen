class InstructionsHandler:
    ...
    def load_instruction_set3(self, ):
        ############################### ASPE ################################
        self.aspe['bos_instruct1'] = """Definisi: Output akan berupa aspek yang meliputi tesktur, whitecast, efek minyak, aroma, harga, waterproof dan polaritas sentimen untuk setiap aspek. Aspek lainnya untuk data yang tidak mengandung aspek tesktur, whitecast, efek minyak, aroma, harga, waterproof
        Positive example 1-
        input: Tekstur sunscreen ini ringan dan mudah meresap ke kulit.
        output: tekstur:positive
        Positive example 2-
        input: Sunscreen ini tidak meninggalkan whitecast dan tahan air saat dipakai di pantai.
        output: whitecast:positive, waterproof:positive
        Negative example 1-
        input: Setelah digunakan, wajah saya menjadi sangat berminyak.
        output: minyak:negative
        Negative example 2-
        input: Harganya terlalu mahal untuk ukuran sunscreen 30ml.
        output: harga:negative
        Neutral example 1-
        input: Sunscreen ini memiliki aroma yang cukup khas, tapi tidak terlalu kuat.
        output: aroma:neutral
        Neutral example 2-
        input: Produk ini memiliki daya tahan yang cukup baik untuk penggunaan harian.
        output: lainnya:positive
        Sekarang lengkapi contoh berikut-
        input: """

        self.aspe['bos_instruct2'] = """Output akan berupa aspek yang meliputi tesktur, whitecast, efek minyak, aroma, harga, waterproof dan polaritas sentimen untuk setiap aspek. Aspek lainnya untuk data yang tidak mengandung aspek tesktur, whitecast, efek minyak, aroma, harga, waterproof
        Positive example 1-
        input: Sunscreen ini memberikan hasil akhir matte dan tidak lengket di kulit.
        output: tekstur:positive
        Positive example 2-
        input: Produk ini tidak meninggalkan whitecast, dan aromanya sangat menyegarkan.
        output: whitecast:positive, aroma:positive
        Negative example 1-
        input: Sunscreen ini meninggalkan residu putih yang sangat terlihat di kulit gelap.
        output: whitecast:negative
        Negative example 2-
        input: Harganya cukup mahal untuk produk lokal dengan ukuran kecil.
        output: harga:negative
        Neutral example 1-
        input: Produk ini memiliki kemasan yang menarik dan praktis digunakan.
        output: lainnya:positive
        Neutral example 2-
        input: Aroma sunscreen ini cukup ringan dan tidak mengganggu.
        output: aroma:neutral
        Sekarang lengkapi contoh berikut-
        input: """
    ...
    def load_instruction_set4(self, ):
        ############################### ASPE ################################
        self.aspe['bos_instruct1'] = """Definisi: Output akan berupa aspek yang meliputi tesktur, whitecast, efek minyak, aroma, harga dan polaritas sentimen untuk setiap aspek. Aspek lainnya untuk data yang tidak mengandung aspek tesktur, whitecast, efek minyak, aroma, harga
        Positive example 1-
        input: Tekstur sunscreen ini ringan dan mudah meresap ke kulit.
        output: tekstur:positive
        Positive example 2-
        input: Sunscreen ini tidak meninggalkan whitecast dan harganya terjangkau.
        output: whitecast:positive, harga:positive
        Negative example 1-
        input: Setelah digunakan, wajah saya menjadi sangat berminyak.
        output: efek minyak:negative
        Negative example 2-
        input: Harganya terlalu mahal untuk ukuran sunscreen 30ml.
        output: harga:negative
        Neutral example 1-
        ...
        self.aspe['bos_instruct2'] = """Output akan berupa aspek yang meliputi tesktur, whitecast, efek minyak, aroma, harga dan polaritas sentimen untuk setiap aspek. Aspek lainnya untuk data yang tidak mengandung aspek tesktur, whitecast, efek minyak, aroma, harga
        Positive example 1-
        input: Sunscreen ini memberikan hasil akhir matte dan tidak lengket di kulit.
        output: tekstur:positive
        Positive example 2-
